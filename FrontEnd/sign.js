...
document.getElementById("signupForm").addEventListener("submit", (event) => {
    ...
    const confirmPasswordError = document.getElementById("signup-confirm-passwordError");
    ...
    if (password.value.trim() === "") {
        ...
        passwordError.textContent = "Your password should be at least 6 characters long, include a lowercase letter, an uppercase letter, and a number.";
        isValid = false;
    } else {
        passwordError.textContent = "";
    }
